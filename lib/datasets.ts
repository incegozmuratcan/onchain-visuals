...
export const datasetGroups: DatasetGroup[] = [
  ...
  },
  {
    ...
    metrics: [
      { id: "chain_realtime_tps", label: "TPS", status: "active", queries: [{ id: "chain_realtime_tps", label: "Real-time TPS by chain", prompt: "Top 30 chains by real-time TPS", status: "active", source: "Chainspect", chip: "TPS" }] },
      { id: "chain_block_time", label: "Block Time", status: "active", queries: [{ id: "chain_block_time", label: "Block time by chain", prompt: "Top 30 chains by block time", status: "active", source: "Chainspect", chip: "Block" }] },
