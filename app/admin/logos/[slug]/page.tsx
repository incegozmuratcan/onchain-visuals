...
function metadataWarning(metadata: unknown) { return typeof metadata === "string" && metadataObject(metadata).parseWarning ? "metadata warning" : null; }
