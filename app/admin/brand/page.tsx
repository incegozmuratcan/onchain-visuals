...
type BrandSettings = Record<string, string>;
...
const defaults: BrandSettings = {
  ...
  metaDescription: "Create clean, source-backed DeFi market cards.",
  primaryLogo: "", darkLogo: "", iconMark: "", headerLogo: "", favicon: "", appleTouchIcon: "", xAvatar: "", xBanner: "", watermarkMark: "",
};

function parseSettings(raw: string | null) {
  if (!raw) return defaults;
  try {
    return { ...defaults, ...JSON.parse(raw) } as BrandSettings;
  } catch {
    return defaults;
  }
}
