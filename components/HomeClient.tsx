  ...
  return (
    <main className="mx-auto min-h-screen max-w-7xl px-4 py-6 md:px-8 md:py-10">
      <header className="mx-auto mb-8 max-w-5xl text-center">
        ...
        <h1 className="mx-auto mt-5 max-w-4xl text-balance text-4xl font-black leading-[0.95] tracking-[-0.06em] text-slate-950 md:text-6xl">{brand.mainSlogan}</h1>
        <p className="mx-auto mt-5 max-w-3xl text-balance text-base font-bold leading-7 text-slate-600 md:text-2xl md:leading-9">
          {brand.heroSubtitle}
        </p>
        <p className="mx-auto mt-3 max-w-2xl text-sm font-semibold text-slate-500 md:text-base">{brand.supportingCopy}</p>
