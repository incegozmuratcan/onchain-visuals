    ...
    return (
      ...
      >
        ...
        >
          <defs>
            <radialGradient
              id="share-btc-daily-watermark-fill"
              cx="46%"
              cy="34%"
              r="78%"
            >
            ...
            <filter
              id="share-btc-daily-watermark-soft-shadow"
              x="-12%"
              y="-14%"
              width="124%"
              height="128%"
            ...
            <filter
              id="share-btc-daily-watermark-symbol-shadow"
              x="-30%"
              y="-30%"
              width="160%"
              height="160%"
          ...
          <path
            ...
            fill="url(#share-btc-daily-watermark-fill)"
            filter="url(#share-btc-daily-watermark-soft-shadow)"
          />
          <text
            x="139"
            y="101"
            textAnchor="middle"
            className="fill-white font-black"
            filter="url(#share-btc-daily-watermark-symbol-shadow)"
            style={{
              fontSize: 72,
              fontFamily:
                'Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
